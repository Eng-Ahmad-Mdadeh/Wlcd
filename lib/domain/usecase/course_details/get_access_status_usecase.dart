...
@Named('GetAccessStatus')
class GetAccessStatusUsecase implements IUseCase<BaseModel<ContractJsonModel>?, CourseDetailsEntity> {
  const GetAccessStatusUsecase(this._repository);
  ...
  ) => _repository.getAccessStatus(data);
}
