...
@Injectable(as: IUseCase<BaseModel<CurriculumModel>?, CourseDetailsEntity>)
@Named('GetCurriculum')
class GetCurriculumUsecase implements IUseCase<BaseModel<CurriculumModel>?, CourseDetailsEntity> {
  const GetCurriculumUsecase(this._repository);

  final ICourseDetailsRepository _repository;

  @override
  Future<Either<AppException, BaseModel<CurriculumModel>?>> call(
    CourseDetailsEntity data,
  ) => _repository.getCurriculum(data);
}
