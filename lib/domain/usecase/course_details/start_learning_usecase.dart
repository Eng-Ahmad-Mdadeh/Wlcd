...
@Named('StartLearning')
class StartLearningUsecase implements IUseCase<BaseModel<ContractJsonModel>?, CourseDetailsEntity> {
  const StartLearningUsecase(this._repository);
  ...
  ) => _repository.startLearning(data);
}
