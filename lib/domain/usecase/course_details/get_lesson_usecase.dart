...
@Injectable(as: IUseCase<BaseModel<LessonModel>?, CourseDetailsEntity>)
@Named('GetLesson')
class GetLessonUsecase implements IUseCase<BaseModel<LessonModel>?, CourseDetailsEntity> {
  const GetLessonUsecase(this._repository);

  final ICourseDetailsRepository _repository;

  @override
  Future<Either<AppException, BaseModel<LessonModel>?>> call(
    CourseDetailsEntity data,
  ) => _repository.getLesson(data);
}
