...
@Named('ListResources')
class ListResourcesUsecase implements IUseCase<BaseModel<ContractJsonModel>?, CourseDetailsEntity> {
  const ListResourcesUsecase(this._repository);
  ...
  ) => _repository.listResources(data);
}
