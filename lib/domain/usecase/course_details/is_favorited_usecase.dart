...
@Named('IsFavorited')
class IsFavoritedUsecase implements IUseCase<BaseModel<ContractJsonModel>?, CourseDetailsEntity> {
  const IsFavoritedUsecase(this._repository);
