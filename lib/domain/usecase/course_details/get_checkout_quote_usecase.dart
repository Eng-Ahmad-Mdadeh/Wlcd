...
@Named('GetCheckoutQuote')
class GetCheckoutQuoteUsecase implements IUseCase<BaseModel<ContractJsonModel>?, CourseDetailsEntity> {
  ...
  ) => _repository.getCheckoutQuote(data);
}
