...
@Named('GetLessonProgress')
class GetLessonProgressUsecase implements IUseCase<BaseModel<ContractJsonModel>?, CourseDetailsEntity> {
  ...
  ) => _repository.getLessonProgress(data);
}
