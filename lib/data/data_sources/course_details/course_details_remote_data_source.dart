...
class CourseDetailsRemoteDataSource extends BaseRemoteDataSource<Object> {
  ...
  Future<Either<AppException, BaseModel<T>?>> _get<T>(String path,
      T Function(JsonMap) parser, {Map<String, dynamic>? query, Map<String, dynamic>? headers,
      bool authenticated = true}) => fetchDataAs<T>(endpoint: path, queryParams: query,
      headers: headers, includeAuthorization: authenticated,
      fromJsonT: (json) => parser(json as JsonMap), wrappedResponse: false);

  Future<Either<AppException, BaseModel<T>?>> _post<T>(String path,
      T Function(JsonMap) parser, {Map<String, dynamic>? data, Map<String, dynamic>? headers}) =>
      postDataAs<T>(endpoint: path, data: data, headers: headers, isFormDate: false,
        fromJsonT: (json) => parser(json as JsonMap), wrappedResponse: false);

  Future<Either<AppException, BaseModel<CourseDetailsModel>?>> getCourseDetails(CourseDetailsEntity e) =>
      _get('/courses/${e.courseId}', CourseDetailsModel.fromJson,
        headers: {if (e.locale != null) 'Accept-Language': e.locale}, authenticated: true);
  ...
  Future<Either<AppException, BaseModel<ContractJsonModel>?>> listReviews(CourseDetailsEntity e) =>
      _get('/courses/${e.courseId}/reviews', ContractJsonModel.fromJson,
        query: e.paginationQuery, authenticated: false);
  ...
  Future<Either<AppException, BaseModel<EnrollmentModel>?>> enrollFree(CourseDetailsEntity e) =>
      _post('/courses/${e.courseId}/enrollments', EnrollmentModel.fromJson, data: e.enrollmentBody,
  ...
  Future<Either<AppException, BaseModel<ContractJsonModel>?>> startLearning(CourseDetailsEntity e) =>
      _post('/enrollments/${e.enrollmentId}/learning/start', ContractJsonModel.fromJson,
        data: e.clientEventBody);
  Future<Either<AppException, BaseModel<ProgressEventModel>?>> recordProgress(CourseDetailsEntity e) =>
      _post('/enrollments/${e.enrollmentId}/lessons/${e.lessonId}/progress-events',
        ProgressEventModel.fromJson, data: e.progressBody);
  Future<Either<AppException, BaseModel<ContractJsonModel>?>> completeLesson(CourseDetailsEntity e) =>
      _post('/enrollments/${e.enrollmentId}/lessons/${e.lessonId}/complete', ContractJsonModel.fromJson,
        data: e.clientEventBody);
  Future<Either<AppException, BaseModel<ResumePositionModel>?>> updateResume(CourseDetailsEntity e) =>
      patchData(endpoint: '/enrollments/${e.enrollmentId}/lessons/${e.lessonId}/resume-position',
        data: e.resumeBody, isFormData: false, fromJsonT: (json) => ResumePositionModel.fromJson(json as JsonMap),
