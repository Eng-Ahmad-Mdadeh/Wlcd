      ...
      child: Row(
        children: [
          ClipRRect(
            ...
            child: Image.network(course.imageUrl, width: AppWidth.w100, height: AppHeight.h85, fit: BoxFit.cover),
          ),
            ...
            child: Column(
              ...
              children: [
                Container(
                  ...
                  child: Text(
                    course.category,
                    style: const TextStyle(color: Color(0xff16a34a), fontSize: 9, fontWeight: FontWeight.w700),
                  ),
                ),
                ...
                Row(
                  children: [
                    const Icon(Icons.star, color: Color(0xfff6b93b), size: 14),
                    Text(
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ClipRRect(
            borderRadius: BorderRadius.circular(AppRadius.r8),
            child: Image.network(course.imageUrl, height: AppHeight.h100, width: double.infinity, fit: BoxFit.cover),
          ),
          ...
          Row(
            children: [
              const Icon(Icons.star, color: Color(0xfff6b93b), size: 14),
              Text(' ${course.rating}', style: const TextStyle(color: Color(0xff6b7280), fontSize: 13)),
            ],
          ),
        ],
      ),
