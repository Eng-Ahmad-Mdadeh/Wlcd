...
import 'package:wlcd/presentation/screens/terms_and_conditions/widgets/terms_and_conditions_dummy_data.dart';
                ...
                child: SingleChildScrollView(
                  ...
                  child: Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        const SectionTitle(text: 'نصوص مؤقتة', maxLines: 2),
                        SizedBox(height: AppHeight.h16),
                        for (int index = 0; index < termsAndConditionsDummySections.length; index++) ...[
                          SectionTitle(text: 'بند تجريبي ${index + 1}', fontSize: AppFontSize.s15, maxLines: 2),
                          SizedBox(height: AppHeight.h8),
                          BodyTitle(
                            text: termsAndConditionsDummySections[index],
